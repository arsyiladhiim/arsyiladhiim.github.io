            ...
            <div class="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 py-8">
                <div class="max-w-2xl w-full">
                    ...
                    <div class="bg-gray-800 rounded-lg p-4 sm:p-6 lg:p-8">
                        <form id="contactForm" action="https://formspree.io/f/mldwpybl" method="POST">
                            ...
                            <div class="mb-4 sm:mb-6">
                                ...
                                <textarea id="message" name="message" rows="4" required class="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all duration-300 resize-none text-sm sm:text-base">
                                </textarea>
                            </div>
